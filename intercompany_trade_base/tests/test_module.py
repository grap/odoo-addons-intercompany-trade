...
class TestModule(TransactionCase):
    ...
    def test_01_create_reverse_intercompany_trade(self):
        ...
        self.assertEqual(
            old_config.customer_partner_id.id, config.supplier_partner_id.id,
            "Create a Reverse Intercompany Trade must reuse customer.")

        self.assertEqual(
            old_config.supplier_partner_id.id, config.customer_partner_id.id,
    ...
    def test_02_update_company_update_partner(self):
        ...
        self.assertEqual(
            config.customer_partner_id.street, new_val,
